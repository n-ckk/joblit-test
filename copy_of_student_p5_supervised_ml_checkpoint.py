# -*- coding: utf-8 -*-
"""Copy_of_Student_P5_Supervised_ML_checkpoint.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/13bF8aOvmC1Oo33z552VGL2OUOEITW-9F
...
pip help install   #complete this
...
plt.scatter(house_sizes, prices, color='g', label='Data Points')              #complete this
plt.xlabel('House Size')                                              #complete this
plt.ylabel('Prices')                                             #complete this
plt.title('House Prices vs House Size')                                            #complete this
plt.legend()
plt.grid(True)
plt.show()
